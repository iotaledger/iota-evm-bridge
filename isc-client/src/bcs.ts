...
export const getMinCommonAccountBalanceOutputs = bcs.struct(
  "getMinCommonAccountBalanceOutputs",
  {
...
export const IscEthereumAddressAgentID = bcs.struct(
  "IscEthereumAddressAgentID",
  {
    chainID: bcs.fixedArray(32, bcs.u8()),
...
export const getRequestIDsForBlockInputs = bcs.struct(
  "getRequestIDsForBlockInputs",
  {
    blockIndex: bcs.option(bcs.u32()),
  },
);

export const getRequestIDsForBlockOutputs = bcs.struct(
  "getRequestIDsForBlockOutputs",
  {
    blockIndex: bcs.u32(),
...
export const isRequestProcessedOutputs = bcs.struct(
  "isRequestProcessedOutputs",
  {
...
export const registerERC721NFTCollectionInputs = bcs.struct(
  "registerERC721NFTCollectionInputs",
  {
...
export const BlocklogOutputRequestReceipt = bcs.struct(
  "BlocklogOutputRequestReceipt",
  {},
);
...
export const getAllowedStateControllerAddressesOutputs = bcs.struct(
  "getAllowedStateControllerAddressesOutputs",
  {
...
export const IscmoveRefWithObject_Anchor = bcs.struct(
  "IscmoveRefWithObject_Anchor",
  {
...
export const balanceBaseTokenEVMInputs = bcs.struct(
  "balanceBaseTokenEVMInputs",
  {
    agentID: bcs.option(IscAgentID),
  },
);

export const balanceBaseTokenEVMOutputs = bcs.struct(
  "balanceBaseTokenEVMOutputs",
  {
...
export const IscevmOffLedgerCallRequest = bcs.struct(
  "IscevmOffLedgerCallRequest",
  {
    chainID: bcs.fixedArray(32, bcs.u8()),
...
export const IscOffLedgerRequestDataEssence = bcs.struct(
  "IscOffLedgerRequestDataEssence",
  {
    allowance: IscAssets,
    chainID: bcs.fixedArray(32, bcs.u8()),
    msg: IscMessage,
...
export const removeAllowedStateControllerAddressInputs = bcs.struct(
  "removeAllowedStateControllerAddressInputs",
  {
...
export const transferAllowanceToInputs = bcs.struct(
  "transferAllowanceToInputs",
  {
    agentID: IscAgentID,
  },
);
...
export const accountObjectsInCollectionInputs = bcs.struct(
  "accountObjectsInCollectionInputs",
  {
    agentID: bcs.option(IscAgentID),
    collectionID: bcs.fixedArray(32, bcs.u8()),
  },
...
export const accountObjectsInCollectionOutputs = bcs.struct(
  "accountObjectsInCollectionOutputs",
  {
...
export const getEventsForRequestInputs = bcs.struct(
  "getEventsForRequestInputs",
  {
    requestID: bcs.fixedArray(32, bcs.u8()),
  },
);
...
export const getEventsForRequestOutputs = bcs.struct(
  "getEventsForRequestOutputs",
  {
...
export const transferAccountToChainInputs = bcs.struct(
  "transferAccountToChainInputs",
  {
    optionalGasReserve: bcs.option(bcs.u64()),
  },
);

export const setMinCommonAccountBalanceInputs = bcs.struct(
  "setMinCommonAccountBalanceInputs",
  {
    minimumAccountBalance: bcs.u64(),
  },
);
...
export const getErrorMessageFormatInputs = bcs.struct(
  "getErrorMessageFormatInputs",
  {
    vmErrorCode: IscVMErrorCode,
  },
);

export const getErrorMessageFormatOutputs = bcs.struct(
  "getErrorMessageFormatOutputs",
  {
...
export const BlocklogRequestReceiptsResponse = bcs.struct(
  "BlocklogRequestReceiptsResponse",
  {
    blockIndex: bcs.u32(),
...
export const LoTuple2_PublicKey_ChangeAccessNodeAction = bcs.struct(
  "LoTuple2_PublicKey_ChangeAccessNodeAction",
  {
...
export const rotateStateControllerInputs = bcs.struct(
  "rotateStateControllerInputs",
  {
...
export const getRequestReceiptsForBlockInputs = bcs.struct(
  "getRequestReceiptsForBlockInputs",
  {
    blockIndex: bcs.option(bcs.u32()),
  },
);

export const getRequestReceiptsForBlockOutputs = bcs.struct(
  "getRequestReceiptsForBlockOutputs",
  {
...
export const delegateChainOwnershipInputs = bcs.struct(
  "delegateChainOwnershipInputs",
  {
...
export const getMaintenanceStatusOutputs = bcs.struct(
  "getMaintenanceStatusOutputs",
  {
    isMaintenance: bcs.bool(),
  },
);

export const LoTuple2_Hname_ContractRecord = bcs.struct(
  "LoTuple2_Hname_ContractRecord",
  {
    a: bcs.u32(),
...
export const addAllowedStateControllerAddressInputs = bcs.struct(
  "addAllowedStateControllerAddressInputs",
  {
    stateControllerAddress: bcs.fixedArray(32, bcs.u8()),
  },
);
